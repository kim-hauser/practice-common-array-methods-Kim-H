...
The second row stores three pastry orders (e.g., “Croissant”, “Muﬃn”,
“Bagel”).
...
const orders = [["latte", "tea", "espresso"],
                ["croissant", "muffin", "bagel",]
];

let drinks = orders[0];
let pastries = orders[1];

console.log(drinks.length);
console.log(pastries.length);

console.log(drinks[0], pastries[2]);
console.log(drinks[1], pastries[1]);
console.log(drinks[2], pastries[0]);

for (let d = 0; d < drinks.length; d++) {
    console.log(drinks[d]);
}

moarDrinks = drinks.push("flat white");
console.log(drinks);
console.log(moarDrinks);
